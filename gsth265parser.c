    ...
    stRPS, NalReader * nr, guint8 stRpsIdx, GstH265SPS * sps)
{
  ...
  if (stRPS->inter_ref_pic_set_prediction_flag) {
    ...
    for (i = 0; i < stRPS->NumNegativePics; i++) {
      READ_UE (nr, delta_poc_s0_minus1[i]);
      /* 7-51 */
    ...
    GstH265NalUnit * nalu, GstH265SliceHdr * slice)
{
  ...
  slice->NumShortTermPictureSliceHeaderBits = 0;
  slice->NumLongTermPictureSliceHeaderBits = 0;
  ...
  if (!slice->dependent_slice_segment_flag) {
    ...
    if ((nalu->type != GST_H265_NAL_SLICE_IDR_W_RADL)
      ...
      bit_position = nr.byte * 8 - nr.bits_in_cache; /* VDPAU bit counting */
      ...
      slice->NumShortTermPictureSliceHeaderBits = nr.byte * 8 - nr.bits_in_cache - bit_position;
      ...
      slice->NumLongTermPictureSliceHeaderBits = nr.byte * 8 - nr.bits_in_cache - bit_position;
